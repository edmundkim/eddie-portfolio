      ...
      <div>
        ...
        >
          <div className="flex -translate-y-5 flex-col items-center gap-4 sm:gap-5 lg:gap-6">
            ...
            <span className="block max-w-full [font-family:var(--homepage-font-display)] text-[3.85rem] font-medium leading-[0.86] tracking-normal text-current sm:text-[5.85rem] md:text-[7rem] lg:text-[8.8rem] xl:text-[11rem] 2xl:text-[12.25rem]">
              Get in touch
            </span>
          </div>
        </a>
